...
  // FIX: Corrected typo from setShowPasasword to setShowPassword
...
            {/* FIX: Inverted the logic for the eye icon */}
            <Ionicons name={showPassword ? 'eye' : 'eye-off'} size={20} color="#999" style={{ marginRight: 10 }} />
          </TouchableOpacity>
        </View>
